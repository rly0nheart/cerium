...
//! Arranges cells into terminal columns, a trimmed vendoring of the `term_grid` crate.
...
///
/// Cells fill columns top-to-bottom, then move to the next column, like `ls`.
...
impl GridDisplay<'_> {
    ...
    fn cell_at(&self, row: usize, col: usize) -> Option<&GridCell> {
        ...
        self.cells.get(col * num_rows + row)
    }
    ...
    fn pad_cell(&self, cell: &GridCell, width: usize) -> String {
