...
- **Total Lines**: 7,316 (6,124 source, 1,192 test)
...
- **[args.rs](cli/args.rs)** – `187 LoEC (Lines of Executable Code)` – CLI argument parser and configuration.
...
- **[grid.rs](display/grid.rs)** – `130 LoEC (Lines of Executable Code)` – Grid display mode for compact multi-column layout.
- **[list.rs](display/list.rs)** – `98 LoEC (Lines of Executable Code)` – List display mode with column-based table output.
...
- **[summary.rs](display/summary.rs)** – `79 LoEC (Lines of Executable Code)` – Summary trait and counting helpers for directory/file totals.
...
- **[text.rs](display/styles/text.rs)** – `155 LoEC (Lines of Executable Code)` – Individual text styles logic.
...
- **[icons.rs](display/theme/icons.rs)** – `810 LoEC (Lines of Executable Code)` – Icons for file types, folders, and extensions.
...
- **[permissions.rs](fs/permissions.rs)** – `85 LoEC (Lines of Executable Code)` – Entry permissions extraction and handling.
...
*Generated by [generate_source_map.py](../scripts/generate_source_map.py) on 02/09/26 22:09:21*