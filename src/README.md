...
- **Total Lines**: 7,407 (6,217 source, 1,190 test)
...
- **[grid.rs](display/grid.rs)** – `151 LoEC (Lines of Executable Code)` – Grid display mode for compact multi-column layout.
- **[list.rs](display/list.rs)** – `117 LoEC (Lines of Executable Code)` – List display mode with column-based table output.
...
- **[summary.rs](display/summary.rs)** – `80 LoEC (Lines of Executable Code)` – Summary trait and counting helpers for directory/file totals.
...
*Generated by [generate_source_map.py](../scripts/generate_source_map.py) on 02/18/26 00:27:52*