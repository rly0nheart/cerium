...
- **Total Lines**: 7,409 (6,219 source, 1,190 test)
...
- **[grid.rs](display/grid.rs)** – `148 LoEC (Lines of Executable Code)` – Grid display mode for compact multi-column layout.
- **[list.rs](display/list.rs)** – `116 LoEC (Lines of Executable Code)` – List display mode with column-based table output.
...
- **[summary.rs](display/summary.rs)** – `86 LoEC (Lines of Executable Code)` – Summary trait and counting helpers for directory/file totals.
- **[traversal.rs](display/traversal.rs)** – `51 LoEC (Lines of Executable Code)` – RecursiveTraversal trait for recursive directory rendering.
...
*Generated by [generate_source_map.py](../scripts/generate_source_map.py) on 02/10/26 14:15:12*